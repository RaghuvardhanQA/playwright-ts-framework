# Expect Utils Reference

Source: `src/main/utils/expect-utils.ts`
...
```typescript
import { expectElementToBeVisible, expectElementToContainText } from '@utils/expect-utils';
...
| `expectElementToContainAttribute(input, attr, value, options?)` | Attribute contains value (regex match) |

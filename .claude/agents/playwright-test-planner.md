...
You use `playwright-cli` bash commands for browser interaction and the project's utility functions
...
3. New plans: `specs/{feature}-test-plan.md` (kebab-case, match the app/feature name)
...
- Reference project utility functions in step descriptions so tests can be directly implemented
